...
import { AllData, AllLinks, DragBackdrop } from '@/models/data';
...
export const initStore = (emit: any) => {
  ...
  const dragBackdrop = reactive(new DragBackdrop());
  provide('dragBackdrop', dragBackdrop);
...
export const useStore = () => {
  return {
     ...
     * 甘特图的拖动背景类
     */
    dragBackdrop: inject('dragBackdrop') as DragBackdrop,
