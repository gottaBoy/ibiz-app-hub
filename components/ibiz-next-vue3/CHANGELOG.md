...
## [0.7.41-alpha.67] - 2026-01-28

### Added

- 新增上下文菜单部件支持引用界面行为组绘制
- 新增工具栏部件支持引用界面行为组绘制
- AI聊天框新增自定义智能体召回配置参数
...
## [0.7.41-alpha.66] - 2026-01-23

### Changed

- 更新简化分页栏样式，仅显示当前激活页码

## [0.7.41-alpha.65] - 2026-01-23
...
## [0.7.41-alpha.63] - 2026-01-16

### Fixed

- 修复导航部件插槽名错误导致同一页面多个导航部件异常

## [0.7.41-alpha.62] - 2026-01-15
...
## [0.7.41-alpha.60] - 2026-01-08

### Fixed

- 修复ai聊天框工具调用区初始显示问题、会话完成工具调用区丢失问题
- 修复重复器嵌套重复器抛值数据隔离异常问题

## [0.7.41-alpha.59] - 2026-01-06

### Added

- 复合表单项扩展组件支持hiddenswitch参数和切换时弹出提示

## [0.7.41-alpha.57] - 2025-12-30
...
- 新增识别应用级工具服务新增注册路由导航完成关闭模态类视图能力，应用参数初始化完成调用
...
## [0.7.41-alpha.48] - 2025-12-10

### Fixed

- 修复气泡飘窗箭头样式显示异常

## [0.7.41-alpha.47] - 2025-12-09
...
## [0.7.41-alpha.46] - 2025-12-08

### Added

- 新增全局截图工具类ibiz.screenShotUtil,可指定目标元素操作后生成base64编码的图片数据
...
## [0.7.41-alpha.45] - 2025-12-05

### Fixed

- 修复markdown编辑器参数tocpos未能读取的问题

## [0.7.41-alpha.44] - 2025-12-04
...
- 新增支持AI聊天话题标题模式参数，支持默认、片段、摘要3种模式
...
## [0.7.41-alpha.36] - 2025-11-10

### Added

- modal工具类补充extendConfirm弹出确认操作方法
- 新增站内信工作流类型通知点击跳转具体流程页面
- 树节点新增title提示
- 直接内容新增title提示

## [0.7.41-alpha.35] - 2025-11-04

### Added

- 新增以 function_ 开头命名的ai工具栏
...
- 优化表单项组件中处理编辑器额外参数逻辑，将其迁移到控制器中处理
...
- 数据关系栏、数据关系分页等部件，在初始化计数器时识别部件状态属性isCounterDisabled（是否禁用计数器）
...
- 新增地图部件srfarealevelnum参数，省级为1，市级为2，以此类推
...
- 新增甘特图部件参数 unit（根据该时间单位呈现右侧甘特页面样式）
- 看板部件新增识别分页栏
- 新增卡片部件拖拽功能
- 新增列表支持新建和拖拽功能
