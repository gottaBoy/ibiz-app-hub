...
class InLineAIButton implements IButtonMenu {
  title: string;
...
// 行内ai按钮
export const InLineAIMenu = {
  key: 'inline-ai',
  factory(): InLineAIButton {
    return new InLineAIButton();
  },
};

// 行内按钮扩展
export const hoverbarKeysEx = {
  link: {
