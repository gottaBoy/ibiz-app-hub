...
const namespace = 'gridColumnPlugin';
...
export function registerGridColumnLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function gridColumnT(key: string, params: Params = {}): string {
...
export const t = gridColumnT;
export const gridColumnLocale = resources;
export { en, zhCN };
