...
export function registerEditorLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function editorT(key: string, params: Params = {}): string {
...
export const t = editorT;
export const editorLocale = resources;
export { en, zhCN };
