...
const namespace = 'panelItemPlugin';
...
export function registerPanelItemLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function panelItemT(key: string, params: Params = {}): string {
...
export const t = panelItemT;
export const panelItemLocale = resources;
export { en, zhCN };
