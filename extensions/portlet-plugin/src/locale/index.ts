...
export function registerPortletLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function portletT(key: string, params: Params = {}): string {
...
export const t = portletT;
export const portletLocale = resources;
export { en, zhCN };
