...
export function registerControlLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function controlT(key: string, params: Params = {}): string {
...
export const t = controlT;
export const controlLocale = resources;
export { en, zhCN };
