...
const namespace = 'toolbarItemPlugin';
...
export function registerToolbarItemLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function toolbarItemT(key: string, params: Params = {}): string {
...
export const t = toolbarItemT;
export const toolbarItemLocale = resources;
export { en, zhCN };
