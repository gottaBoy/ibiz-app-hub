...
export function registerUiLogicNodeLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function uiLogicNodeT(key: string, params: Params = {}): string {
...
export const t = uiLogicNodeT;
export const uiLogicNodeLocale = resources;
export { en, zhCN };
