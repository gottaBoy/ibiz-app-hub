...
export function registerAcItemLocale(): void {
  const i18n = getHost();
  if (!i18n) return;
...
export function acItemT(key: string, params: Params = {}): string {
...
export const t = acItemT;
export const acItemLocale = resources;
export { en, zhCN };
