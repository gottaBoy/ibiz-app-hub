export { AppDataUploadViewController } from './view/app-data-upload-view.controller';
...
export { MDCustomViewController } from './view/md-custom-view.controller';
export { HtmlViewController } from './view/html-view.controller';
