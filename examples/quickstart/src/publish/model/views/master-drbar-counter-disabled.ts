export default {
  ...
  loadDefault: true,
  deviewCodeName: 'drbar_counter_disabled',
  deviewId: '1efbaf5989fec90374c668c9558a7d96',
  appWFId: 'workflow',
  accUserMode: 3,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      uniqueTag: 'master_drbar_counter_disabled__drbar',
      autoLoad: true,
    ...
    {
      codeName: 'drbar_counter_disabled_datainfobar',
      ...
      name: 'datainfobar',
      id: 'drbar_counter_disabled_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.MASTER',
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'drbar_counter_disabled_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '1536f07232b9547c7b57bfc082646098',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERdrbar_counter_disabled',
  id: 'web.master_drbar_counter_disabled',
};
