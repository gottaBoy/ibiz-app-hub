export default {
  deviewCodeName: 'Tree_entitynode',
  ...
  caption: '树视图_实体节点',
  codeName: 'master_tree_entitynode',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        caption: '树视图_实体节点',
        codeName: 'tree_entitynode_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'web.master',
        controlParam: {},
        name: 'captionbar',
        id: 'tree_entitynode_captionbar',
      },
    ],
  ...
  name: 'MASTERTree_entitynode',
  id: 'web.master_tree_entitynode',
};
