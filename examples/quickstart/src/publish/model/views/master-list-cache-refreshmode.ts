export default {
  ...
  loadDefault: true,
  deviewCodeName: 'list_cache_refreshmode',
  deviewId: '27ed28b395bbf6ce92c90906943efb40',
  appWFId: 'workflow',
  accUserMode: 3,
  capLanguageRes: {
  ...
  caption: '缓存刷新',
  codeName: 'master_list_cache_refreshmode',
  ...
  controls: [
    {
      ...
      xdataControlName: 'list',
      codeName: 'list_cache_refreshmode_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'list_cache_refreshmode_toolbar',
    },
    {
      groupMode: 'NONE',
      groupStyle: 'DEFAULT',
    ...
    },
    {
      ...
      caption: '缓存刷新',
      codeName: 'list_cache_refreshmode_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'list_cache_refreshmode_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '836a65f8817d580ff65bdc38019141bc',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERlist_cache_refreshmode',
  id: 'web.master_list_cache_refreshmode',
};
