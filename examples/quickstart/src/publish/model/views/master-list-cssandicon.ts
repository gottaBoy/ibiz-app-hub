export default {
  ...
  caption: '红色标签与图标',
  codeName: 'master_list_cssandicon',
  ...
  controls: [
    {
      ...
      itemLayoutPanel: {
        ...
        codeName: 'usr0516058530',
        controlType: 'PANEL',
        logicName: 'list_cssandicon',
        appDataEntityId: 'web.master',
        controlParam: {},
        sysCss: {
          cssName: 'mdctrl-red-label',
        },
        modelId: '1f2afe9e1a3a645736ae6f5b1cf7e9dd',
      ...
      codeName: 'list_cssandicon_list',
      controlType: 'LIST',
      logicName: 'list_cssandicon_List',
      appDataEntityId: 'web.master',
      controlParam: {
        id: 'list',
      },
      modelId: '535265d8e19fc8a580145461f9bf4ca3',
      modelType: 'PSDELIST',
      name: 'list',
      id: 'web.master.list_cssandicon_list',
    },
    {
      groupMode: 'SINGLE',
    ...
    },
    {
      ...
      caption: '红色标签与图标',
      codeName: 'list_cssandicon_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'list_cssandicon_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
