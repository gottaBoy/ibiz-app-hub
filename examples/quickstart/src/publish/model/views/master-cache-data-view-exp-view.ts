export default {
  ...
  loadDefault: true,
  deviewCodeName: 'cacheDataViewExpView',
  deviewId: 'f64f8834f59186aeb9a2be2c2d887965',
  appWFId: 'workflow',
  accUserMode: 2,
  capLanguageRes: {
  ...
  caption: '数据卡片导航_启用缓存',
  codeName: 'master_cache_data_view_exp_view',
  ...
  controls: [
    {
      ...
      controls: [
        {
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 'usr6974_data_view_exp_view_data_view',
          controlType: 'DATAVIEW',
          logicName: '数据卡片导航_缓存_卡片视图',
          appDataEntityId: 'web.master',
          controlLogics: [
            {
          ...
          modelId: 'c421f20e412f02ff58d4901d8deb19c4',
          modelType: 'PSDEDATAVIEW',
          name: 'dataviewexpbar_dataview',
          id: 'web.master.usr6974_data_view_exp_view_data_view',
        },
      ],
      codeName: 'cache_data_view_exp_view_dataviewexpbar',
      ...
      width: 750,
      modelId: 'c3eaa160a7bc3121528b884124126c48_dataviewexpbar',
      modelType: 'PSEXPBAR',
      name: 'dataviewexpbar',
      id: 'cache_data_view_exp_view_dataviewexpbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
    ...
    },
    {
      ...
      caption: '数据卡片导航_启用缓存',
      codeName: 'cache_data_view_exp_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'cache_data_view_exp_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'c3eaa160a7bc3121528b884124126c48',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERcacheDataViewExpView',
  id: 'web.master_cache_data_view_exp_view',
};
