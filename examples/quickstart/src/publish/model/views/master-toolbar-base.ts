      ...
      },
      {
        detoolbarItems: [
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_toolbar_base_toolbar3_deuiaction12_click@master',
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_toolbar_base_toolbar3_deuiaction2_click@master',
            uiactionTarget: 'SINGLEDATA',
            valid: true,
            caption: '打开实体视图',
            itemType: 'DEUIACTION',
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_toolbar_base_toolbar3_deuiaction3_click@master',
            uiactionTarget: 'SINGLEDATA',
            valid: true,
            caption: '打开链接',
            itemType: 'DEUIACTION',
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_toolbar_base_toolbar3_deuiaction11_click@master',
            uiactionTarget: 'NONE',
            valid: true,
            caption: '自定义代码',
            itemType: 'DEUIACTION',
        ...
        codeName: 'toolbar_base_toolbar3',
        controlType: 'TOOLBAR',
        logicName: '按钮行为类型',
        appDataEntityId: 'web.master',
        controlParam: {
        ...
        modelId: 'a3238cd09261e46565b3029c2ffa1686',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar3',
        id: 'toolbar_base_toolbar3',
      },
      {
        detoolbarItems: [
          {
            actionLevel: 100,
            noPrivDisplayMode: 2,
            uiactionId: 'async_action@master',
            uiactionTarget: 'NONE',
            valid: true,
            caption: '异步操作',
            itemType: 'DEUIACTION',
        ...
        codeName: 'toolbar_base_toolbar4',
        controlType: 'TOOLBAR',
        logicName: '异步任务_工具栏',
        appDataEntityId: 'web.master',
        controlParam: {
        ...
        modelId: 'e3957b12fa45b6c43c1ff32126c1cf7e',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar4',
        id: 'toolbar_base_toolbar4',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.MASTER',
