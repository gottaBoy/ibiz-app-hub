export default {
  ...
  accUserMode: 2,
  caption: '自动化规则看板',
  codeName: 'psde_logic_flow_panel_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
        ...
        dechartSerieses: [
          {
            ...
            seriesCodeListId: 'web.extension__log_state',
            seriesType: 'bar',
            valueField: 'srfcount',
        ...
        chartDataSets: [
          {
            chartDataSetFields: [
              ...
              {
                codeListId: 'web.extension__log_state',
                groupField: true,
                index: 1,
                name: 'STATE',
                id: '1',
      ...
      },
      {
        detoolbarItems: [
          {
            actionLevel: 100,
            noPrivDisplayMode: 2,
            uiactionId: 'open_all_log@psdelogic',
            uiactionTarget: 'NONE',
            valid: true,
            caption: '更多',
            itemType: 'DEUIACTION',
        ...
        codeName: 'flow_panel_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '更多日志_工具栏',
        appDataEntityId: 'web.psdelogic',
        controlParam: {
  ...
  modelId: '85137cacc3729b8947b91c3ff5083fb5',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDELogicflow_panel_view',
  id: 'web.psde_logic_flow_panel_view',
};
