export default {
  ...
  loadDefault: true,
  deviewCodeName: 'detail_mdctrl_view',
  deviewId: '8fbb9915a19d7925c0742586cde7974a',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.DETAIL',
  },
  caption: '明细多数据部件表单视图',
  codeName: 'detail_detail_mdctrl_view',
  ...
  controls: [
    ...
    },
    {
      ...
      xdataControlName: 'form',
      codeName: 'detail_mdctrl_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'detail_mdctrl_view_toolbar',
    },
    {
      codeName: 'detail_mdctrl_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'detail_mdctrl_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.DETAIL',
      ...
      caption: '明细多数据部件表单视图',
      codeName: 'detail_mdctrl_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.detail',
      controlParam: {},
      name: 'captionbar',
      id: 'detail_mdctrl_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '46b5a82d5532aa1819c2fe8b3a4f262f',
  modelType: 'PSAPPDEVIEW',
  name: 'DETAILdetail_mdctrl_view',
  id: 'web.detail_detail_mdctrl_view',
};
