export default {
  ...
  loadDefault: true,
  deviewCodeName: 'sedit_view',
  deviewId: '4c566ca01e5780a0df3c26e92ab61b4c',
  accUserMode: 3,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.REGION',
  },
  caption: '编辑视图',
  codeName: 'region_sedit_view',
  ...
  controls: [
    ...
    {
      codeName: 'sedit_view_datainfobar',
    ...
    },
    {
      ...
      caption: '编辑视图',
      codeName: 'sedit_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.region',
      controlParam: {},
      name: 'captionbar',
      id: 'sedit_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '81c91e5412946e4bf24fa0ddca7c3fac',
  modelType: 'PSAPPDEVIEW',
  name: 'REGIONsedit_view',
  id: 'web.region_sedit_view',
};
