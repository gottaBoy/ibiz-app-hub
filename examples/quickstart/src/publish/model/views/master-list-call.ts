export default {
  ...
  loadDefault: true,
  deviewCodeName: 'list_call',
  deviewId: '895267b10ac2a77a0a8a32bc31e0696f',
  appWFId: 'workflow',
  accUserMode: 3,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '部件调用',
      codeName: 'list_call_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'list_call_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '7a1de89989fac420055dddd99851f7ea',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERlist_call',
  id: 'web.master_list_call',
};
