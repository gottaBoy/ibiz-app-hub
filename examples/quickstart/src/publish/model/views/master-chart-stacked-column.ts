export default {
  ...
  caption: '图表_堆叠柱状图',
  codeName: 'master_chart_stacked_column',
  ...
  appViewMsgGroupId: 'chart_stackedcolumn',
  controls: [
    {
      ...
      codeName: 'usr05154958_search_form',
      controlType: 'SEARCHFORM',
      logicName: '图表_堆叠柱状图_搜索表单',
      appDataEntityId: 'web.master',
      controlParam: {
        id: 'searchform',
      },
      modelId: 'cae4630197c3eae7e019fb9ed0b631ad',
      modelType: 'PSDEFORM_SEARCHFORM',
      name: 'searchform',
      id: 'web.master.usr05154958_search_form',
    },
    {
      coordinateSystem: 'XY',
      ...
      modelId: '2d6c71f4ce3074133f73ddc6ed334ec5',
      modelType: 'PSDECHART',
      userParam: {
        'EC.color':
    ...
    },
    {
      ...
      caption: '图表_堆叠柱状图',
      codeName: 'chart_stacked_column_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'chart_stacked_column_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: 'e6d67d0c23baf2a34dfe7ec597d56cb9',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERChart_stackedColumn',
  id: 'web.master_chart_stacked_column',
};
