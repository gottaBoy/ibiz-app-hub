export default {
  ...
  loadDefault: true,
  deviewCodeName: 'noCacheDataViewExpView',
  deviewId: '44cdb7e9f4fe2cd63aaf5e2a5cbbdc71',
  appWFId: 'workflow',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MASTER',
  },
  caption: '数据卡片导航_不启用缓存',
  ...
  controls: [
    {
      ...
      controls: [
        {
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 'usr5895_data_view_exp_view_data_view',
          controlType: 'DATAVIEW',
          logicName: '数据卡片导航_不启用缓存_卡片视图',
          appDataEntityId: 'web.master',
          controlLogics: [
            {
          ...
          modelId: '6a4195a27aeb849ea11bcc9bf86f58f1',
          modelType: 'PSDEDATAVIEW',
          name: 'dataviewexpbar_dataview',
          id: 'web.master.usr5895_data_view_exp_view_data_view',
        },
      ],
      codeName: 'no_cache_data_view_exp_view_dataviewexpbar',
      ...
      width: 750,
      modelId: '143774c2037db22c2dc39abc48ad4355_dataviewexpbar',
      modelType: 'PSEXPBAR',
      name: 'dataviewexpbar',
      id: 'no_cache_data_view_exp_view_dataviewexpbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
    ...
    },
    {
      ...
      caption: '数据卡片导航_不启用缓存',
      codeName: 'no_cache_data_view_exp_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'no_cache_data_view_exp_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '143774c2037db22c2dc39abc48ad4355',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERnoCacheDataViewExpView',
