export default {
  ...
  loadDefault: true,
  deviewCodeName: 'listNocacheListExpView',
  deviewId: '3c1c3aa15da8299637846f00b7d49ddf',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      controls: [
        {
          ...
          itemLayoutPanel: {
            ...
            layoutPanel: true,
            codeName: 'aa66eb3369cfc5b3338',
            controlType: 'PANEL',
            logicName: 'listNocacheListExpView_List列表',
            appDataEntityId: 'web.region',
            controlParam: {},
            modelId: '50dddffab670e9cb3a5fcd5551524dda',
            modelType: 'PSSYSVIEWPANEL',
            name: 'listexpbar_list_itempanel',
            id: 'web.region.aa66eb3369cfc5b3338',
          },
          pagingSize: 1000,
          showHeader: true,
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 'list_nocache_list_exp_view_list',
          controlType: 'LIST',
          logicName: 'List6',
          appDataEntityId: 'web.region',
          controlLogics: [
          ...
          modelId: '84e506354be0350bdcdfc6fa100099d5',
          modelType: 'PSDELIST',
          name: 'listexpbar_list',
          id: 'web.region.list_nocache_list_exp_view_list',
        },
      ],
      codeName: 'list_nocache_list_exp_view_listexpbar',
      ...
      width: 750,
      modelId: '0d3e7428a98bfbc4d4268d76a53b3377_listexpbar',
      modelType: 'PSEXPBAR',
      name: 'listexpbar',
      id: 'list_nocache_list_exp_view_listexpbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
    ...
    },
    {
      ...
      caption: '列表导航_不启用缓存',
      codeName: 'list_nocache_list_exp_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.region',
      controlParam: {},
      name: 'captionbar',
      id: 'list_nocache_list_exp_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '0d3e7428a98bfbc4d4268d76a53b3377',
  modelType: 'PSAPPDEVIEW',
  name: 'REGIONlistNocacheListExpView',
