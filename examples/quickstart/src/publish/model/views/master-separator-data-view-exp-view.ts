export default {
  ...
  loadDefault: true,
  deviewCodeName: 'separatorDataViewExpView',
  deviewId: '3857cde3185348d05b1dce3f491daaa2',
  appWFId: 'workflow',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MASTER',
  },
  caption: '数据卡片导航_快速搜索提示分隔符',
  ...
  controls: [
    {
      ...
      controls: [
        {
          ...
          itemLayoutPanel: {
            ...
            layoutPanel: true,
            codeName: 'a6eab8cf90877ac7285',
            controlType: 'PANEL',
            logicName: '卡片导航_提示分隔符',
            appDataEntityId: 'web.master',
            controlParam: {},
            modelId: '03bd5235ae9dbde6ab32eef165d64e6a',
            modelType: 'PSSYSVIEWPANEL',
            name: 'itemlayoutpanel',
            id: 'web.master.a6eab8cf90877ac7285',
          },
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 'usr1474_data_view_exp_view_data_view',
          controlType: 'DATAVIEW',
          logicName: '数据卡片导航_快速搜索提示分隔符_卡片视图',
          appDataEntityId: 'web.master',
          controlLogics: [
            {
          ...
          modelId: '57d1134468760d8cf85814875fac59a1',
          modelType: 'PSDEDATAVIEW',
          name: 'dataviewexpbar_dataview',
          id: 'web.master.usr1474_data_view_exp_view_data_view',
        },
      ],
      codeName: 'separator_data_view_exp_view_dataviewexpbar',
      ...
      width: 750,
      modelId: 'a08973b45ac1d59cc5c42429fafadce7_dataviewexpbar',
      modelType: 'PSEXPBAR',
      name: 'dataviewexpbar',
      id: 'separator_data_view_exp_view_dataviewexpbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
    ...
    },
    {
      ...
      caption: '数据卡片导航_快速搜索提示分隔符',
      codeName: 'separator_data_view_exp_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'separator_data_view_exp_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '数据卡片导航_快速搜索提示分隔符',
  viewStyle: 'DEFAULT',
  viewType: 'DEDATAVIEWEXPVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'a08973b45ac1d59cc5c42429fafadce7',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERseparatorDataViewExpView',
