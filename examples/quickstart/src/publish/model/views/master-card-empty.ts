export default {
  ...
  loadDefault: true,
  deviewCodeName: 'card_empty',
  deviewId: '9a1e5e3a3d1b3b3324551f2b6e0db5be',
  appWFId: 'workflow',
  accUserMode: 3,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '卡片_无值内容',
      codeName: 'card_empty_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'card_empty_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '19487b32511e478fd3e5c8b7119c4899',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERcard_empty',
  id: 'web.master_card_empty',
};
