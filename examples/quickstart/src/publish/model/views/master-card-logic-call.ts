export default {
  ...
  loadDefault: true,
  deviewCodeName: 'card_logic_call',
  deviewId: '40967f4f58653ff0d2a04f903188a30c',
  appWFId: 'workflow',
  accUserMode: 3,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      xdataControlName: 'dataview',
      codeName: 'card_logic_call_toolbar',
      controlType: 'TOOLBAR',
      logicName: '多数据_部件能力调用',
      appDataEntityId: 'web.master',
      controlParam: {
        id: 'toolbar',
      },
      modelId: '0b8396eaa54bfcbfc42552e7a5b514cf',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'card_logic_call_toolbar',
    },
    {
      groupMode: 'SINGLE',
    ...
    },
    {
      ...
      caption: '部件调用',
      codeName: 'card_logic_call_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'card_logic_call_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '89d790624d85bf18a2e222b8a9d7d194',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERcard_logic_call',
