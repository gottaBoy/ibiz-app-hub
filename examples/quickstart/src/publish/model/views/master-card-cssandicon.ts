export default {
  ...
  caption: '红色标签与图标',
  codeName: 'master_card_cssandicon',
  ...
  controls: [
    {
      ...
      itemLayoutPanel: {
        ...
        modelId: '464392da882884af897ece54d986a0eb',
      ...
      codeName: 'card_cssandicon_data_view',
      controlType: 'DATAVIEW',
      logicName: '卡片_界面样式及图标_卡片视图',
      appDataEntityId: 'web.master',
      controlParam: {
        id: 'dataview',
      },
      modelId: '411bc94713eae6589697af7232cf4785',
      modelType: 'PSDEDATAVIEW',
      name: 'dataview',
      id: 'web.master.card_cssandicon_data_view',
    },
    {
      groupMode: 'SINGLE',
    ...
    },
    {
      ...
      caption: '红色标签与图标',
      codeName: 'card_cssandicon_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.master',
      controlParam: {},
      name: 'captionbar',
      id: 'card_cssandicon_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
