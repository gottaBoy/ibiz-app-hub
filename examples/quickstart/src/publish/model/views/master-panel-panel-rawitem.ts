export default {
  deviewCodeName: 'panel_panel_rawitem',
  deviewId: 'c2d77614d38362b40cfbea2851203b59',
  appWFId: 'workflow',
  accUserMode: 2,
  capLanguageRes: {
  ...
  caption: '面板_直接内容',
  codeName: 'master_panel_panel_rawitem',
    ...
    rootPanelItems: [
        ...
        panelItems: [
          {
            rawItem: {
              content:
                '<p><span style="color: rgb(66, 144, 247);">Html内容</span></p>',
              contentType: 'HTML',
              predefinedType: 'STATIC_TEXT',
              id: 'static_text',
            },
      ...
      },
      {
        ...
        panelItems: [
          ...
          {
            rawItem: {
              caption: '说明：占位无内容显示，只是占据对应的布局空间',
              halign: 'LEFT',
    ...
    controls: [
      {
        ...
        caption: '面板_直接内容',
        codeName: 'panel_panel_rawitem_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'web.master',
        controlParam: {},
        name: 'captionbar',
        id: 'panel_panel_rawitem_captionbar',
      },
    ],
    codeName: 'aeab4044bccb9029aeb',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'panel_panel_rawitem',
    appDataEntityId: 'web.master',
    controlParam: {},
    modelId: 'bacde21e5fa9449c0df85b6b94c5a3bd',
    modelType: 'PSSYSVIEWLAYOUTPANEL',
    name: 'layoutpanel',
    id: 'aeab4044bccb9029aeb',
  },
  title: '面板_直接内容',
  viewStyle: 'DEFAULT',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '200f2fd0f6fc5c469900aa5cda0e88eb',
  modelType: 'PSAPPDEVIEW',
  name: 'MASTERpanel_panel_rawitem',
  id: 'web.master_panel_panel_rawitem',
};
