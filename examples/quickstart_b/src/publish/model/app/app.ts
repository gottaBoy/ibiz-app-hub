export default {
  appDEUIActions: [
    ...
    },
    {
      ...
      buttonStyle: 'DEFAULT',
      caption: 'gitee',
      codeName: 'panel_layoutpanel_gitee_click',
      frontProcessType: 'OPENHTMLPAGE',
      fullCodeName: 'panel_layoutpanel_gitee_click',
      htmlPageUrl: 'https://gitee.com/ibizlab-cloud/ibiz-app-hub',
      uiactionMode: 'FRONT',
      uiactionTag: 'panel_layoutpanel_gitee_click',
      uiactionType: 'DEUIACTION',
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      name: 'gitee',
      id: 'panel_layoutpanel_gitee_click',
    },
    {
      actionLevel: 100,
      buttonStyle: 'DEFAULT',
  ...
  appFuncs: [
    {
      appFuncType: 'APPVIEW',
      codeName: 'child_appb_add1',
      openMode: 'INDEXVIEWTAB',
      appViewId: 'web.master_child_appb_view2',
      name: '子应用b追加',
      id: 'child_appb_add1',
    },
    {
    ...
    },
    {
      ...
      codeName: 'child_appb',
      openMode: 'INDEXVIEWTAB',
      appViewId: 'web.master_child_appb_view',
      name: '子应用B占位视图',
      id: 'child_appb',
    },
    {
